...
- **Forgot your password?** Click "Forgot password?" on the sign-in
  screen, type the name, and a brand new password is generated and shown
  immediately — you're logged straight in with it.
- **Want to change your password?** There's a "Change password" button on
  the dashboard, under Account. It generates a new one on the spot and
  shows it once.
